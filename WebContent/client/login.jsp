								...
								<table width="85%" border="0" cellspacing="0">
									<tr>
												...
												<table width="100%" border="0" cellspacing="0">
													<tr>
														<td style="text-align:center; padding-top:20px">
															<img src="${pageContext.request.contextPath }/client/images/logintitle.jpg" width="150" height="30" />
														</td>
													</tr>
													<tr>
										...
										<td style="text-align:left; padding-top:30px; width:60%"><h1>您还没有注册？</h1>
											<p>XYX百货商城欢迎您的到来！</p>
											<p>这里商品类型繁多，种类齐全，耐用可靠，质量过关！</p>
											<p>快来注册吧！！</p>
											<p style="text-align:left">
												<a href="${pageContext.request.contextPath }/client/register.jsp">
													<img src="${pageContext.request.contextPath }/client/images/signupbutton.jpg" width="135" height="33" />
												</a>
											</p>
										</td>
									</tr>
